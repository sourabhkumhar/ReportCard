...
if(isset($_GET['view'])) {
    if ($_SESSION['teacherOf'] == "BCA I yr") {
        $sql = "SELECT * FROM `bca_1yr` WHERE `stu_enrollNo` = '" . $_GET['view'] . "'";
        ...
        $sql = "SELECT * FROM `bca_2yr` WHERE `stu_enrollNo` = '" . $_GET['view'] . "'";
        $result = mysqli_query($conn, $sql);
        $numRow = mysqli_num_rows($result);
        ...
        $sql = "SELECT * FROM `bca_3yr` WHERE `stu_enrollNo` = '" . $_GET['view'] . "'";
        $result = mysqli_query($conn, $sql);
        $numRow = mysqli_num_rows($result);
